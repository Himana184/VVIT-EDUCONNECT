  ...
  return (
    <Card className="max-w-full">
      ...
      <CardContent className="space-y-4">
        {
          role != "student" && <div className="space-y-1">
      ...
      <CardFooter className='flex justify-between'>
        {
          internship?.offerLetter && <a href={internship?.offerLetter} target="_blank" rel="noreferrer">
        ...
        {
          internship?.completionCertificate && <a href={internship?.completionCertificate} target="_blank" rel="noreferrer">
            <Button variant="outline" className="flex space-x-2 items-center border-primary">
              <CloudArrowDownIcon className="h-7 w-7" />
              <p>Certificate</p>
            </Button>
